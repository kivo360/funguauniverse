...
# # Copy everything that bento has done and run.
...
#         summary_name, summary_name + ' request latency')
...
#     app.add_url_rule('/feedback', 'feedback',
#                      feedback_view_func, methods=['POST', 'GET'])
